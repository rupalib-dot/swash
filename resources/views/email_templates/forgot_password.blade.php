...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Swash Wash - Password Reset!</title>
		<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
		<style type="text/css">
			*{font-family: 'Roboto', sans-serif;margin:0px;padding: 0px;}
			h4{color: #000; font-size: 34px;font-weight: 400;margin-bottom: 20px;}
			strong{color: #000; font-size: 18px;font-weight: 300;margin-bottom: 15px;}
			p{color: #555555;font-size: 15px;font-weight: 300;margin-bottom: 15px;line-height: 25px; display: block}
		</style>
	</head>
		...
		<div style="max-width: 600px; margin:0 auto;">
			<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
				...
				<div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
                       ...
                       <h4>Dear <?php if(empty($details['name'])){ 'User';} else{ ?> {{$details['name']}} <?php } ?></h4>

                       <p>You recently requested to reset your  Swash Wash Account password.</p>

                        <p>Please enter below one time password to reset your password.</p>
                        ...
                        <p>If you did not request a password reset then, please ignore this email. This password reset is only valid for the next 1 hour.</p>



                        <p>Kind Regards,</p>

                        <p><b>SWash Wash Team</b></p>
				</div>
			</div>
		</div>
	</body>
